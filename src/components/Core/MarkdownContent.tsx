...
export default function MarkdownContent({ content, className }: MarkdownContentProps) {
  return (
    <div className={cn(
      "prose max-w-none",
      "prose-headings:font-mono prose-headings:text-[#000080]",
      "prose-p:font-mono prose-p:text-gray-800 prose-p:leading-relaxed",
      ...
      "prose-code:not([class*='language-']):border prose-code:not([class*='language-']):border-gray-600 prose-code:not([class*='language-']):font-mono",
      ...
      "prose-li:font-mono prose-li:text-gray-800",
